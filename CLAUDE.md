...
"Mother of AI" course: a learner-focused, week-by-week build of a production-grade RAG system (arXiv paper curator) using FastAPI, PostgreSQL, OpenSearch hybrid search, Docling, LangGraph agentic RAG, Airflow, and a Telegram bot. See [README.md](README.md) for the full curriculum and architecture.
